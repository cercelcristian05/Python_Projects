        ...
        if result.multi_face_landmarks:
            for face_landmarks in result.multi_face_landmarks:  
                ...
                try:
                    ...
                    retrieve_validation = DeepFace.find(temp_file_path, './cropped_faces/', model_name="Facenet", enforce_detection=True)
                    first_identity = str(retrieve_validation[0]["identity"][0])  
                    
                    next_result = DeepFace.verify(temp_file_path, first_identity, model_name="Facenet", enforce_detection=True)
